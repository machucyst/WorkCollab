                ...
                try {
                    ...
                    db.CreateGroup(a, leader, filteredIds, new DatabaseFuncs.UpdateListener() {
                        ...
                        public void onUpdate(Map group) {
                            ...
                            requireActivity().getSupportFragmentManager().beginTransaction().replace(((ViewGroup) (getView().getParent())).getId(), SelectedGroupFragment.newInstance(CreateGroupFragment.this.user,user)).addToBackStack(null).commit();
